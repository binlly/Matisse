...
import kotlinx.android.synthetic.main.photo_capture_item.view.*
...
class AlbumMediaAdapter(
    ...
    private val mSelectionSpec: SelectionSpec = SelectionSpec.getInstance()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder? {
        if (viewType == VIEW_TYPE_CAPTURE) {
            ...
            holder.itemView.setOnClickListener { v ->
                val onPhotoCapture = v.context as? OnPhotoCapture ?: return@setOnClickListener
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, cursor: Cursor) {
        if (holder is CaptureViewHolder) {
            ...
            val ta = holder.itemView.context.theme.obtainStyledAttributes(intArrayOf(R.attr.capture_textColor))
            ...
            holder.mMediaGrid.preBindMedia(
                    MediaGrid.PreBindInfo(getImageResize(holder.mMediaGrid.context), mPlaceholder,
                            mSelectionSpec.countable, holder))
    ...
    override fun onThumbnailClicked(thumbnail: ImageView, item: Item, holder: RecyclerView.ViewHolder) {
        val onMediaClickListener = mOnMediaClickListener
    ...
    private fun notifyCheckStateChanged() {
        ...
        val checkStateListener = mCheckStateListener
    ...
    private class CaptureViewHolder internal constructor(itemView: View): RecyclerView.ViewHolder(itemView) {
        val mHint: TextView = itemView.hint
    }
